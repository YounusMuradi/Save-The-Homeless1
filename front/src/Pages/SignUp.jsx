            ...
            >
              ...
              <div className="flex flex-row mb-1 ">
                <select
                  ...
                  id=""
                >
                  <option value="">{t("afghanistan")}</option>
                  <option value="">{t("iran")}</option>
                  <option value="">{t("turkey")}</option>
                  <option value="">{t("pakistan")}</option>
                </select>
              </div>
            ...
            <form action="" className=" bg-backgorund w-96">
              ...
              <div className="flex flex-row mb-1 ">
                ...
                >
                  ...
                  <option value="">{t("sawad")}</option>
                  <option value="">{t("english")}</option>
                  <option value="">{t("paint")}</option>
                </select>
              </div>
              <div className="flex flex-row mb-8 ">
                <select
